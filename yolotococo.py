...
parser.add_argument('--root_dir', default='/root/autodl-tmp/',type=str, help="root path of images and labels, include ./images and ./labels and classes.txt")
parser.add_argument('--save_path', type=str,default='/root/autodl-tmp/annotations/test.json', help="if not split the dataset, give a path to a json file")
